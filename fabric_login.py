...
class GithubLogin():
    ...
    def get_token(self):
        ...
        authenticity_token = html.xpath('//div[@id="login"]//input[@name="authenticity_token"]/@value')
    ...
    def isLogin(self):
        ...
        info = selector.xpath('//div[@class="col-8"]//dl/dd/input/@value')
...
if __name__ == "__main__":
    ...
    # 输入自己email账号和密码
    #github.post_account(email='fxlts@163.com', password='zqbx2oo8!')
    # 验证是否登陆成功
    github.isLogin()